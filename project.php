...
<form action="selectp.php" method="POST">
  ...
  <input type="text" id="fname" name="fname" placeholder="Enter username"><br>
  <label>password:</label><br>
  <input type="password" name="password" placeholder="Enter password"><br><br><br>
  <input type="submit" value="Submit"><br>
<a style="color:red" href="signupp.php">Sign up</a><br><br>
<a style="color:red" href="loginpp.php">Customer</a>
</form> 
</section>
